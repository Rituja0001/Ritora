...
/**
 * FeaturedProjects / FeaturedProperties Component
...
export default function FeaturedProperties() {
  ...
  return (
    <section id="projects" className="py-24 bg-[#0C3332] text-white relative z-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap gap-2 flex-shrink-0">
            {["All", "Villa", "Penthouse"].map((category) => (
              <button
                ...
                className={`px-4 py-2 text-xs uppercase tracking-[0.16em] font-medium transition-all duration-300 rounded-sm border ${
            ...
            >
              <div className="relative aspect-[16/10] overflow-hidden bg-[#082221]">
                ...
                <div className="absolute top-4 left-4 right-4 flex items-center justify-between pointer-events-none">
                  <span className="px-3 py-1 bg-[#0C3332]/90 backdrop-blur-md border border-[#D9BA6A]/40 text-[#D9BA6A] text-[10px] uppercase tracking-[0.2em] font-semibold">
                    {item.type}
                  </span>
                  <span className="px-2.5 py-1 bg-[#D9BA6A] text-[#0C3332] text-[10px] uppercase tracking-[0.18em] font-bold shadow-md">
                    {item.badge}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  ...
                  <h3 className="font-serif text-xl text-white group-hover:text-[#D9BA6A] transition-colors line-clamp-1">
                    {item.title}
                  </h3>
                </div>

                <div className="grid grid-cols-3 gap-2 py-3 border-y border-[#D9BA6A]/15 text-neutral-200 text-xs">
                  <div className="flex items-center gap-2">
                    <Bed className="w-4 h-4 text-[#D9BA6A]" />
                    <span>{item.beds} Beds</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Bath className="w-4 h-4 text-[#D9BA6A]" />
                    <span>{item.baths} Baths</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Maximize2 className="w-3.5 h-3.5 text-[#D9BA6A]" />
                    <span>{item.area}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-2">
                  <div>
                    ...
                    <div className="font-serif text-lg font-bold text-[#D9BA6A]">
                      {item.price}
                    </div>
                  ...
                  <a
                    href="#"
                    className="flex items-center gap-1.5 px-3.5 py-2 border border-[#D9BA6A]/50 hover:border-[#D9BA6A] text-neutral-100 hover:text-[#0C3332] hover:bg-[#D9BA6A] text-xs uppercase tracking-wider font-semibold transition-all duration-300 rounded-sm"
                  >
        ...
        <div className="mt-14 text-center">
          <a
            href="#"
            className="inline-flex items-center gap-3 px-8 py-4 border border-[#D9BA6A] text-[#D9BA6A] hover:bg-[#D9BA6A] hover:text-[#0C3332] text-xs uppercase tracking-[0.2em] font-bold transition-all duration-300 shadow-sm hover:shadow-gold-glow"
          >
